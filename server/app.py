...
#     health_num = response_dict["health_num"]
#     medication_list = response_dict["medication_list"]
...
#     response_dict = convert_json_to_dict(response)
#     health_num = response_dict["health_num"]
#     demographics = response_dict["demographics"]
...
#     response_dict = convert_json_to_dict(response)
#     health_num = response_dict["health_num"]
#     allergies = response_dict["allergies"]
...
#     response_dict = convert_json_to_dict(response)
#     health_num = response_dict["health_num"]
#     lab_work = response_dict["lab_work"]
...
#     response_dict = convert_json_to_dict(response)
#     health_num = response_dict["health_num"]
#     billing_code = response_dict["billing_code"]
...
@app.route('/test/flask_test/<id>', methods=["GET"])
def flask_test(id):
    print(id)
    return id + "42"
